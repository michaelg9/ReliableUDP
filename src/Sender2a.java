...
public class Sender2a {
	...
	public static void main(String[] args) {
        if (args.length != 5) {
            System.out.println("Usage: java Sender2a <RemoteHost> <RemotePort> <Filename> <RetryTimeout> <WindowSize>");
            return;
        }
        try {
            ...
            GBNClient sender = new GBNClient(args[0], remotePort, retryTimeout, windowSize);
